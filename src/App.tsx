      ...
      <div className="flex justify-center items-center min-h-[70vh]">
        <div className="w-full max-w-7xl bg-gradient-to-br from-blue-50 via-white to-blue-100 rounded-3xl border-2 border-blue-100 shadow-xl transition duration-100 p-4 md:p-10 xl:p-16">
          ...
          >
            ...
            {/* Referral #4 */}
            <div className="bg-gray-200 rounded-xl p-6 shadow transition duration-100 hover:bg-gray-300/80">
              <h3 className="text-2xl font-bold mb-4">Referral #4 Information:</h3>
              <label className="block font-semibold mb-1">Referral First & Last Name, Phone Number, and Your Relationship To This Person.</label>
              <textarea name="referral4" className="w-full rounded px-3 py-2 border border-gray-300" rows={5} placeholder="Enter Referral Info Here" />
            </div>
            {/* Referral #5 */}
            <div className="bg-gray-200 rounded-xl p-6 shadow transition duration-100 hover:bg-gray-300/80">
              <h3 className="text-2xl font-bold mb-4">Referral #5 Information:</h3>
              <label className="block font-semibold mb-1">Referral First & Last Name, Phone Number, and Your Relationship To This Person.</label>
              <textarea name="referral5" className="w-full rounded px-3 py-2 border border-gray-300" rows={5} placeholder="Enter Referral Info Here" />
            </div>
            {/* Consent and Submit */}
            <div className="md:col-span-2 flex flex-col items-center mt-4">
              ...
              <button className="bg-gradient-to-r from-blue-500 to-blue-700 text-white px-10 py-4 rounded-lg font-bold text-lg shadow hover:scale-[1.01] hover:shadow-blue-200/30 transition duration-100">Submit Response<br /><span className="text-xs font-normal">Click Here</span></button>
            </div>
          </form>
        </div>
      </div>
